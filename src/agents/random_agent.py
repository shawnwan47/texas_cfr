    ...
    def choose_action(self, state):
        ...
        # Handle Raise action
            ...
            if state.min_bet > 0 and state.pot > 0: # Heuristic: BB is likely related to initial bets/pot
                 ...
                 likely_bb = state.min_bet if state.stage == pokers.Stage.Preflop and state.pot <= 3 * state.min_bet else state.min_bet / 2
            ...
            if pokers.ActionEnum.Fold in state.legal_actions:
                ...
                return pokers.Action(pokers.ActionEnum.Check) # Or Check if Fold is illegal
